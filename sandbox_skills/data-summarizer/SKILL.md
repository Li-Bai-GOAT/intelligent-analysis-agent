...
description: Analyzes CSV and Excel files, generates summary stats, and plots quick visualizations using Python and pandas.
metadata:
  version: 3.0.0
  dependencies: python>=3.8, pandas>=2.0.0, matplotlib>=3.7.0, seaborn>=0.12.0, openpyxl>=3.0.0
---

# Data Summarizer

This Skill analyzes CSV and Excel files and provides comprehensive summaries with statistical insights and visualizations.

## When to Use This Skill

Claude should use this Skill whenever the user:
- Uploads or references a CSV or Excel file (.csv, .xlsx, .xls)
- Asks to summarize, analyze, or visualize tabular data
- Requests insights from spreadsheet data
...
The Skill provides a Python function `summarize_data(file_path)` that:
- Accepts a path to a CSV or Excel file (.csv, .xlsx, .xls)
...
- For Excel files with multiple sheets, analyzes the first sheet by default
