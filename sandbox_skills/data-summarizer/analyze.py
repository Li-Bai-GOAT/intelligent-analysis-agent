...
def summarize_data(file_path):
    """
    Comprehensively analyzes a CSV or Excel file and generates multiple visualizations.
    
    Args:
        file_path (str): Path to the CSV or Excel file (.csv, .xlsx, .xls)
    ...
    summary.append("=" * 60)
    summary.append(f"File Type: {file_type}")
